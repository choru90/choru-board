...
import choru.board.comment.repository.ArticleCommentCountRepository;
import choru.board.comment.repository.CommentRepositoryV2;
...
public class CommentServiceV2 {
    ...
    public List<CommentResponse> readAllInfiniteScroll(Long articleId, String lastPath, Long pageSize){
        List<CommentV2> commentList = lastPath == null?
